      ...
      >
        <div className="flex items-center justify-between px-6 py-6 max-w-6xl mx-auto">
          <button
            ...
            className="font-semibold text-gray-900 dark:text-white transition-colors duration-300 hover:text-sky-600 dark:hover:text-sky-400 cursor-pointer"
          >
            Aman Dwivedi
          </button>
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-16">
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center group">
                <div className="bg-gradient-to-br from-purple-200 to-purple-300 dark:from-purple-800 dark:to-purple-900 rounded-2xl p-2 h-96 flex items-center justify-center transition-all duration-500 group-hover:scale-105">
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-80 h-80 flex items-center justify-center transition-all duration-300 group-hover:shadow-2xl overflow-hidden">
                    <img
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center group">
                <div className="md:order-2">
                  <div className="bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-800 dark:to-blue-900 rounded-2xl p-2 h-96 flex items-center justify-center transition-all duration-500 group-hover:scale-105">
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-80 h-80 flex items-center justify-center transition-all duration-300 group-hover:shadow-2xl overflow-hidden">
                      <img
                ...
                <div className="md:order-1 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-full text-sm transition-colors duration-300">
                      Next.js
                    </span>
                    <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-full text-sm transition-colors duration-300">
                      Node.js
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center group">
                <div className="bg-gradient-to-br from-sky-100 to-sky-200 dark:from-sky-800 dark:to-sky-900 rounded-2xl p-2 h-96 flex items-center justify-center transition-all duration-500 group-hover:scale-105">
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-80 h-80 flex items-center justify-center transition-all duration-300 group-hover:shadow-2xl overflow-hidden">
                    <img
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center group">
                <div className="md:order-2">
                  <div className="bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-800 dark:to-amber-900 rounded-2xl p-2 h-96 flex items-center justify-center transition-all duration-500 group-hover:scale-105">
                    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-80 h-80 flex items-center justify-center transition-all duration-300 group-hover:shadow-2xl overflow-hidden">
                      <img
              ...
              {/* Project 5 - Charitap */}
              <div className="grid md:grid-cols-2 gap-12 items-center group">
                <div className="bg-gradient-to-br from-green-100 to-green-200 dark:from-green-800 dark:to-green-900 rounded-2xl p-2 h-96 flex items-center justify-center transition-all duration-500 group-hover:scale-105">
                  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-80 h-80 flex items-center justify-center transition-all duration-300 group-hover:shadow-2xl overflow-hidden">
                    <img
        ...
        <section id="about" className="py-20 scroll-mt-24 transition-colors duration-300">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="group">
                <div className="bg-gradient-to-br from-amber-100 to-amber-200 dark:from-amber-800 dark:to-amber-900 rounded-2xl p-8 h-[28rem] flex items-center justify-center transition-all duration-500 group-hover:scale-105">
                  <div className="w-80 h-80 rounded-full overflow-hidden shadow-2xl transition-all duration-300 group-hover:shadow-3xl">
                    <img
              ...
              <div className="lg:col-span-2 grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="flex items-center space-x-4 group cursor-pointer p-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 block"
                  >
                    <div className="w-12 h-12 bg-sky-400 dark:bg-sky-500 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110">
                      <Mail className="w-6 h-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <p className="text-sm text-gray-500 dark:text-gray-400">Email</p>
                      <span className="text-lg text-gray-700 dark:text-gray-300 transition-colors duration-300 group-hover:text-sky-600 dark:group-hover:text-sky-400 font-medium">
                        dwivedi@ucdavis.edu
                      </span>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <span className="text-lg text-gray-700 dark:text-gray-300 hover:text-sky-600 dark:hover:text-sky-400 transition-colors duration-300 font-medium">
                        LinkedIn Profile
                      </span>
                    </div>
                  </a>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4 group cursor-pointer p-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300">
                    <div className="w-12 h-12 bg-sky-400 dark:bg-sky-500 rounded-full flex items-center justify-center transition-all duration-300 group-hover:scale-110">
                      <MapPin className="w-6 h-6 text-white" />
                    </div>
                    <div className="flex-1">
                      <p className="text-sm text-gray-500 dark:text-gray-400">Location</p>
                      <span className="text-lg text-gray-700 dark:text-gray-300 transition-colors duration-300 font-medium">
                        Davis, CA
                      </span>
                    </div>
                  </div>
